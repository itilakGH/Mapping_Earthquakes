...
// Creating the earthquake & tectonic plates layers for out map
//let overLayGroup = L.LayerGroup();
//let mapOverlay1 = mapOverlay(this.earthquakes).addTo(overLayGroup);
//let mapOverlay2 = mapOverlay(this.plates).addTo(overLayGroup);
let earthquakes = new L.LayerGroup();
let tectonicplates = new L.LayerGroup();
// We define an object that contains the overlays
let overlays = {
	//"Overlays": this.overLayGroup
...
// Accessing the website with the JSON data via URL
